...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 03, 2019 at 10:16 PM
...
CREATE TABLE `orderdetails` (
  `orderDetailsNumber` int(11) NOT NULL,
...
INSERT INTO `orderdetails` (`orderDetailsNumber`, `orderNumber`, `productCode`, `quantityOrdered`, `priceEach`, `orderLineNumber`) VALUES
...
ALTER TABLE `orderdetails`
  ADD PRIMARY KEY (`orderDetailsNumber`);
...
--
ALTER TABLE `orderdetails`
  MODIFY `orderDetailsNumber` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2997;
--
-- AUTO_INCREMENT for table `payments`
--
ALTER TABLE `payments`
  MODIFY `paymentNumber` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=274;
